...
predict in latent space - that's the whole point of JEPA (LeCun 2022). the encoder learns what matters because it never has to look on token details or noise.
